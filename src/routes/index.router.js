...
import { handleUserValidation, userLoginRules } from '../middlewares/users.validator.js';
...
router.post('/log-in', userLoginRules, handleUserValidation('index'), authenticate);
